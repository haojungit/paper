	...
	<div class="log_body">
		...
		<div class="log_main">
			<div class="log_mainbody">
				...
				<div class="log_right">
					<form id="myform" name="myform" action="/user/login" method="post">
						...
						<label id="checkCodeMsg" style="color: red;">${checkCodeError}</label> &nbsp;&nbsp; <a style="cursor: pointer;" onClick="myReload()">看不清？换张图片</a><br />
						<br />
						<button
		...
		<div class="login_bottom">Copyright &copy; 2012-2016</div>
	</div>
</body>
</html>
