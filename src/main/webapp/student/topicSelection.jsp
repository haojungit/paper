...
<script src="<%=basePath%>js/topicSelection.js"></script>
...
<body>
	<input id="studentMajor" type="hidden" value="${student.studentMajor}" />
	<table style="width: 100%; border: 0; cellpadding: 0; cellspacing: 0;">
		<tr>
			<td style="background: url(../images/mail_leftbg.gif) repeat-y" />
			<td>
				<table id="topicSelectiondg" style="width: auto; height: auto;">
...
<script>
	topicSelection($('#studentMajor').val());
</script>
</html>
