...
<script src="<%=basePath%>js/teacherInterimCheckUp.js"></script>
...
<td valign="top" bgcolor="#F7F8F9">
	<form>
		...
		<table border="1" WIDTH="100%" BORDERCOLORLIGHT="#b1c9ff"
			...
			<tr>
				<td colspan="6" style="height: 30px;">&nbsp;计划完成时间：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input id="interimCheckFinishDate" class="easyui-datebox" disabled
					data-options="formatter:myformatter,parser:myparser,editable:false"></input>
				</td>
			</tr>
			<tr>
				<td colspan="6" class="left15">进展情况：<br /> <textarea disabled
			...
			<tr>
				<td colspan="6" class="left15">指导教师意见：<br> <textarea
						id="tComment" name="textarea" rows="10" cols="90"></textarea>
		...
		<div class="noprint">
			<div style="float: left;">
				<input id="interImCheckSubmit" type="button" value="提交"
					onclick="interImCheckUpSave()" />
			</div>
			<div style="float: left;">
				<input type="button" value="打印输出" onclick="window.print()" />
			</div>
			<div style="float: left;">
				<input type="button" value="发送消息" id="bt_checkupMsg"/>
			</div>
		</div>
	</form>
</td>
