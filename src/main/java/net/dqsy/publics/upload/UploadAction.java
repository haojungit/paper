...
public class UploadAction extends ActionSupport
{
  ...
  public String delPaperTemplate()
  {
    File file = new File(getRealPath(new StringBuilder(String.valueOf(File.separatorChar)).append("upload")
      .append(File.separatorChar).append("paperTemplate").append(File.separatorChar).toString()) + File.separator + this.uploadFileName); if (!file.exists()) return "error"; if (file.isFile()) file.delete(); return "SUCCESS";
  }
  ...
  public PaperStudentService getPaperStudentService() {
    return this.paperStudentService;
  }
  ...
  public PaperGuidancerecordService getPaperGuidancerecordService() {
    return this.paperGuidancerecordService;
  }
