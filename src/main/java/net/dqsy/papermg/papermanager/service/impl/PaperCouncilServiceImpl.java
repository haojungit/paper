...
{
  PaperCouncilDAO paperCouncilDAO;
  PaperTeacherService paperTeacherService;
  PaperCouncilmanDAO paperCouncilmanDAO;
  PaperUserRoleService paperUserRoleService;
  PaperUserService paperUserService;
  PaperRoleService paperRoleService;

  public void setPaperCouncilDAO(PaperCouncilDAO paperCouncilDAO)
  {
    this.paperCouncilDAO = paperCouncilDAO;
  }

  public void setPaperCouncilmanDAO(PaperCouncilmanDAO paperCouncilmanDAO) {
    this.paperCouncilmanDAO = paperCouncilmanDAO;
  }
  ...
  public PaperUserService getPaperUserService() {
    return this.paperUserService;
  }
  ...
  public PaperRoleService getPaperRoleService() {
    return this.paperRoleService;
  }
  ...
  public PaperCouncilDAO getPaperCouncilDAO() {
    return this.paperCouncilDAO;
  }

  public PaperTeacherService getPaperTeacherService() {
    return this.paperTeacherService;
  }

  public PaperCouncilmanDAO getPaperCouncilmanDAO() {
    return this.paperCouncilmanDAO;
  }
}