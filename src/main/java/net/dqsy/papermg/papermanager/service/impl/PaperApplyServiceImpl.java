  ...
  implements PaperApplyService
{
  ...
  public PaperApplyDAO getPaperApplyDAO()
  {
    return this.paperApplyDAO;
  }

  public void setPaperApplyDAO(PaperApplyDAO paperApplyDAO) {
    this.paperApplyDAO = paperApplyDAO;
  }
