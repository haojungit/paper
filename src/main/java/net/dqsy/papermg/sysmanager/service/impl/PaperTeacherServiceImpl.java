  ...
  implements PaperTeacherService
{
  ...
  public PaperTeacher findById(int id)
  {
    try
    {
      return (PaperTeacher)this.paperTeacherDAO.findById(
        "com.pactera.papermg.sysmanager.po.PaperTeacher", id);
    } catch (PaperManagerException e) {
      e.printStackTrace();
    }return null;
  }
  ...
  public List findTeacherName(String teacherUnits)
  {
    ...
    {
      return find(
        "select new com.pactera.papermg.sysmanager.po.PaperTeacher(teacherId,teacherName) from PaperTeacher where teacherUnits = '" + 
  ...
  public void setPaperTeacherDAO(PaperTeacherDAO paperTeacherDAO) {
    this.paperTeacherDAO = paperTeacherDAO;
  }
