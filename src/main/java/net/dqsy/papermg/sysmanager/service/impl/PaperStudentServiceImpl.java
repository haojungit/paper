  ...
  public PaperStudent findById(int id)
  {
    try
    {
      return (PaperStudent)this.paperStudentDAO.findById(
        "com.pactera.papermg.sysmanager.po.PaperStudent", id);
    } catch (PaperManagerException e) {
      e.printStackTrace();
    }return null;
  }
  ...
  public List findStudentMajor(String teacherUnits)
  {
    try
    {
      return this.paperStudentDAO
        .find("select new com.pactera.papermg.sysmanager.vo.StudentMajorVO(studentMajor) from PaperStudent where studentFaculty = '" + 
